...
In this class/activity we worked on combining multiple datasets using the different join commands.
...
```{r}
ggplot(daily_births_1980, aes(x = date, y = total, color = week_day, shape = holiday)) +
  geom_point() + 
  geom_line() + 
  labs(title = "Total Number of Babies Born per Day in 1980",
       x = "Date",
       y = "Total Births",
...
Yes, there tends to be a lower total birth on a holiday compared to the average total birth of the day.
