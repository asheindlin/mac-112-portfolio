...
In this activity we worked on transforming character variables into factor variables and assigning values to these factors. We also worked on altering the value levels of these variables. I had fun doing it.
