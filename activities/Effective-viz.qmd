...
ggplot(weather, aes(y = temp3pm, x = temp9am, color = location)) + 
  geom_point() + 
  labs(x = "Temp3am", y = "Temp9am", title = "Temperature", color = "Location")  
```
...
```{r}
#| fig-cap: "Comparing temperatures at 3pm and 9am in different locations"

ggplot(weather, aes(y = temp3pm, x = temp9am, color = location)) + 
  geom_point() + 
  labs(x = "Temp3am", y = "Temp3pm", color = "Location")  
```
...
```{r}
#| fig-cap: "Density plots of 3pm temperatures in 3 Australian locations."
#| fig-alt: "This is a density chart"
